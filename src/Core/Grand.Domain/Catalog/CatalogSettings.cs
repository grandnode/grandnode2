...
public class CatalogSettings : ISettings
{
    ...
    /// <summary>
    ///     Gets or sets a value indicating customers should see "discontinued" message when visiting details pages of
    ...
    /// <summary>
    ///     Gets or sets a value indicating whether to use customer product prices. It can significantly improve performance
    ///     when disable.
    /// </summary>
    public bool CustomerProductPrice { get; set; }

    /// <summary>
    ///     Gets or sets a value indicating whether to ignore load Filterable Specification Attribute Option (side-wide). It
    ///     can significantly improve performance when enabled.
    /// </summary>
    public bool IgnoreFilterableSpecAttributeOption { get; set; }

    /// <summary>
    ///     Gets or sets a value indicating whether to ignore load Filterable available start and end date products
    ///     (side-wide). It can significantly improve performance when enabled.
    /// </summary>
    ...
    /// <summary>
    ///     Gets or sets the max value for page size to use for pagination on all brands/all collection/all vendors/ all
    ///     categories page
    /// </summary>
