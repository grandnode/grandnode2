...
public class CustomerSettings : ISettings
{
    ...
    /// <summary>
    ///     Gets or sets a value indicating whether users can check the availability of usernames (when registering or changing
    ///     in 'My Account')
    /// </summary>
    ...
    /// <summary>
    ///     Gets or sets a number of passwords that should not be the same as the previous one; 0 if the customer can use the
    ///     same password time after time
    /// </summary>
