...
namespace Grand.Business.Catalog.Tests.Services.Products
{
    ...
    public class ProductAttributeServiceTests
    {
        ...
        public async Task UpdateProductAttributeMappingTest()
        {
            ...
            //Assert
            Assert.IsTrue(_repository.Table.FirstOrDefault(x => x.Id == product.Id).ProductAttributeMappings.FirstOrDefault(x => x.Id == pm1.Id).TextPrompt == "test");
        }
        ...
        public async Task DeleteProductAttributeValueTest()
        {
            ...
            //Assert
            Assert.AreEqual(1, _repository.Table.FirstOrDefault(x => x.Id == product.Id).ProductAttributeMappings.FirstOrDefault(x => x.Id == pm1.Id).ProductAttributeValues.Count);
        }
        ...
        public async Task UpdateProductAttributeValueTest()
        {
            ...
            //Assert
            Assert.IsTrue(_repository.Table.FirstOrDefault(x => x.Id == product.Id).ProductAttributeMappings.FirstOrDefault(x => x.Id == pm1.Id).ProductAttributeValues.FirstOrDefault().Name == "test");
        }
        ...
        public async Task DeleteProductAttributeCombinationTest()
        {
            ...
            //Assert
            Assert.AreEqual(2, _repository.Table.FirstOrDefault(x => x.Id == product.Id).ProductAttributeCombinations.Count);
        }
        ...
        public async Task InsertProductAttributeCombinationTest()
        {
            ...
            //Assert
            Assert.AreEqual(1, _repository.Table.FirstOrDefault(x => x.Id == product.Id).ProductAttributeCombinations.Count);
        }
        ...
        public async Task UpdateProductAttributeCombinationTest()
        {
            ...
            //Assert
            Assert.IsTrue(_repository.Table.FirstOrDefault(x => x.Id == product.Id).ProductAttributeCombinations.FirstOrDefault(x => x.Id == pac1.Id).Text == "test");
        }
    }
}