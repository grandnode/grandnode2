...
[TestClass]
public class WarehouseControllerAttributeTests
{
    private static readonly Type ControllerType = typeof(WarehouseController);
    ...
    [TestMethod]
    public void CreateWarehouse_Get_And_Post_BothPresent()
    {
        var methods = ControllerType.GetMethods().Where(m => m.Name == "CreateWarehouse").ToList();
