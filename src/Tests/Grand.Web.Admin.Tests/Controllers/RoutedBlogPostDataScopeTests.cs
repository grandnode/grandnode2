...
[TestClass]
public class RoutedBlogPostDataScopeTests
{
    private static RoutedBlogPostDataScope Build(string? area)
    {
        ...
        var global = new GlobalAdminDataScope<BlogPost>();
        var store = new StoreAdminDataScope<BlogPost>(BuildContextAccessor());
        return new RoutedBlogPostDataScope(httpContextAccessorMock.Object, global, store);
    }
