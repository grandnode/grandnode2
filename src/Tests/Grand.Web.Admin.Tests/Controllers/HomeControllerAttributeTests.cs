...
public class HomeControllerAttributeTests
{
    ...
    {
        var attr = typeof(HomeController).GetCustomAttributes(typeof(AuthorizeAdminAttribute), inherit: false);
    ...
    // Admin (it inherits BaseHomeControllerWithSetLanguage), unlike Vendor.
    [TestMethod]
