...
[TestClass]
public class RoutedBrandDataScopeTests
{
    private static RoutedBrandDataScope Build(string area, out Mock<IAdminDataScope<Brand>> globalMock, out Mock<IAdminDataScope<Brand>> storeMock)
    {
        ...
        var global = new GlobalAdminDataScope<Brand>();
        var store = new StoreAdminDataScope<Brand>(BuildContextAccessor());
        globalMock = null;
        storeMock = null;
        return new RoutedBrandDataScope(httpContextAccessorMock.Object, global, store);
    }
