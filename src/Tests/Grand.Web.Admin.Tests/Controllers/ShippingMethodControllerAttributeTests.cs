...
[TestClass]
public class ShippingMethodControllerAttributeTests
{
    private static readonly Type ControllerType = typeof(ShippingMethodController);
    ...
    [TestMethod]
    public void CreateMethod_Get_And_Post_BothPresent()
    {
        var methods = ControllerType.GetMethods().Where(m => m.Name == "CreateMethod").ToList();
