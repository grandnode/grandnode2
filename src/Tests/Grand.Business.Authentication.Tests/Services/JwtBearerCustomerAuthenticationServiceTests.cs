...
namespace Grand.Business.Authentication.Tests.Services
{
    ...
    public class JwtBearerCustomerAuthenticationServiceTests
    {
        ...
        public void Init()
        {
            ...
            _jwtBearerCustomerAuthenticationService = new JwtBearerCustomerAuthenticationService(_customerServiceMock.Object, _permissionServiceMock.Object, _groupService.Object, _refreshTokenServiceMock.Object);
        }
        ...
        public async Task Valid_NullToken_ReturnFalse()
        {
            ...
            var result = await _jwtBearerCustomerAuthenticationService.Valid(context);
            Assert.IsFalse(result);
            Assert.AreEqual(await _jwtBearerCustomerAuthenticationService.ErrorMessage(), "Invalid token or cancel by refresh token");
        }
        ...
        public async Task Valid_NoPermissions_Customer_ReturnFalse()
        {
            ...
            var result = await _jwtBearerCustomerAuthenticationService.Valid(context);
            Assert.IsFalse(result);
            Assert.AreEqual(await _jwtBearerCustomerAuthenticationService.ErrorMessage(), "You do not have permission to use API operation (Customer group)");
        }
        [TestMethod()]
