...
namespace Grand.Business.Marketing.Tests.Services.Campaigns
{
    ...
    public class CampaignServiceTests
    {
        ...
        public void Init()
        {
            ...
            _campaignService = new CampaignService(_campaignRepository, _campaignHistoryRepository, _newsLetterSubscriptionRepository, _customerRepository,
                _emailSenderMock.Object, _queuedEmailServiceMock.Object, _storeServiceMock.Object, _mediatorMock.Object, _languageServiceMock.Object, _workContextMock.Object);
        ...
        public async Task InsertCampaignTest()
        {
            ...
            //Assert
            _mediatorMock.Verify(c => c.Publish(It.IsAny<EntityInserted<Campaign>>(), default(CancellationToken)), Times.Once);
        ...
        public async Task UpdateCampaignTest()
        {
            ...
            //Assert
            _mediatorMock.Verify(c => c.Publish(It.IsAny<EntityUpdated<Campaign>>(), default(CancellationToken)), Times.Once);
        ...
        public async Task DeleteCampaignTest()
        {
            ...
            //Assert
            _mediatorMock.Verify(c => c.Publish(It.IsAny<EntityDeleted<Campaign>>(), default(CancellationToken)), Times.Once);
