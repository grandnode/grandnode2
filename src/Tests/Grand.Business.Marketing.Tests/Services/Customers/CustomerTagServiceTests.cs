...
namespace Grand.Business.Marketing.Tests.Services.Customers
{
    ...
    public class CustomerTagServiceTests
    {
        ...
        public async Task InsertTagToCustomerTest()
        {
            ...
            //Assert
            Assert.IsTrue(_repositoryCustomer.Table.FirstOrDefault(x=>x.Id == customer.Id).CustomerTags.Contains(customerTag.Id));
        }
        ...
        public async Task DeleteTagFromCustomerTest()
        {
            ...
            //Assert
            Assert.IsFalse(_repositoryCustomer.Table.FirstOrDefault(x => x.Id == customer.Id).CustomerTags.Contains(customerTag.Id));
        }
        ...
        public async Task UpdateCustomerTagProductTest()
        {
            ...
            //Assert
            Assert.IsTrue(_repositoryCustomerTagProduct.Table.FirstOrDefault(x=>x.Id == customerTagProduct.Id).DisplayOrder == 10);
        }
