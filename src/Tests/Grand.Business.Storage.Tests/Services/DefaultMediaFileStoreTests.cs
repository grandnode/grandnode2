    ...
    public class DefaultMediaFileStoreTests
    {
        ...
        public void Init()
        {
            _defaultMediaFileStore = 
                ...
                new FileSystemStore(NUnit.Framework.TestContext.CurrentContext.TestDirectory));
        }
        ...
        {
            //Arrange
            var result = await _defaultMediaFileStore.CreateFileFromStream("file456.txt", new MemoryStream(Encoding.UTF8.GetBytes("test")), true);
            //Act
