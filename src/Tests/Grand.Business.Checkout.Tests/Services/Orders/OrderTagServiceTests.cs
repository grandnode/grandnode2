...
namespace Grand.Business.Checkout.Tests.Services.Orders
{
    ...
    public class OrderTagServiceTests
    {
        ...
        public async Task AttachOrderTagTest()
        {
            ...
            //Assert
            Assert.IsTrue(_orderRepository.Table.FirstOrDefault(x => x.Id == order.Id).OrderTags.Any(z => z == orderTag.Id));
        ...
        public async Task DetachOrderTagTest()
        {
            ...
            //Assert
            Assert.IsFalse(_orderRepository.Table.FirstOrDefault(x => x.Id == order.Id).OrderTags.Any(z => z == orderTag.Id));
