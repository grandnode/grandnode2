    ...
    public class ShoppingCartServiceTests
    {
        ...
        public void Init()
        {
            ...
            _shoppingCartService = new ShoppingCartService(_workContextMock.Object, _productServiceMock.Object,
                 _customerServiceMock.Object, _mediatorMock.Object, _userFieldServiceMock.Object, _shoppingCartValidatorMock.Object, _shoppingCartSettings);
        }
        ...
        public async Task UpdateShoppingCartItemTest()
        {
            ...
            //Act
            var result = await _shoppingCartService.UpdateShoppingCartItem(customer, item.shoppingCartItem.Id, "", new List<CustomAttribute>(), null);
            //Assert
            _customerServiceMock.Verify(x => x.UpdateShoppingCartItem(It.IsAny<string>(), It.IsAny<ShoppingCartItem>()), Times.Once);
        }
        ...
        public async Task DeleteShoppingCartItemTest()
        {
            ...
            //Assert
            _customerServiceMock.Verify(x => x.DeleteShoppingCartItem(It.IsAny<string>(), It.IsAny<ShoppingCartItem>()), Times.Once);
        }
