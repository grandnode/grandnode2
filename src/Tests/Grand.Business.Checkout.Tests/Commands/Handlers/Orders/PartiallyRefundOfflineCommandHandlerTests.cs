...
namespace Grand.Business.Checkout.Tests.Commands.Handlers.Orders
{
    ...
    public class PartiallyRefundOfflineCommandHandlerTests
    {
        ...
        public void Init()
        {
            ...
            _handler = new PartiallyRefundOfflineCommandHandler(_orderServiceMock.Object, _paymentTransactionMock.Object, _mediatorMock.Object, _messageProviderServiceMock.Object, new Domain.Localization.LanguageSettings());
        }
