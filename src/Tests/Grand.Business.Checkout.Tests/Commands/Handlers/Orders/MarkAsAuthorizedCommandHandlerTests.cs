...
{
    [TestClass()]
    public class MarkAsAuthorizedCommandHandlerTests
    {
        private MarkAsAuthorizedCommandHandler _handler;
        ...
        public void Init()
        {
            ...
            _handler = new MarkAsAuthorizedCommandHandler(_orderServiceMock.Object, _paymentTransactionMock.Object, _mediatorMock.Object);
        }
