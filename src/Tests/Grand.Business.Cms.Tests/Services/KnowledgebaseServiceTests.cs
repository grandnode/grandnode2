...
namespace Grand.Business.Cms.Tests.Services
{
    ...
    public class KnowledgebaseServiceTests
    {
        ...
        public async Task UpdateKnowledgebaseCategoryTest()
        {
            ...
            //Assert
            Assert.IsTrue(_repositoryKnowledgebaseCategory.Table.FirstOrDefault(x => x.Id == knowledgebaseCategory.Id).Name == "test");
        }
        ...
        public async Task UpdateKnowledgebaseArticleTest()
        {
            ...
            //Assert
            Assert.IsTrue(_repositoryKnowledgebaseArticle.Table.FirstOrDefault(x => x.Id == knowledgebaseArticle.Id).Name == "test");
        }
        ...
        public async Task DeleteArticleCommentTest()
        {
            ...
            //Assert
            Assert.IsNull(_repositoryKnowledgebaseArticleComment.Table.FirstOrDefault(x=>x.Id == knowledgebaseArticleComment.Id));
        }
    }
}