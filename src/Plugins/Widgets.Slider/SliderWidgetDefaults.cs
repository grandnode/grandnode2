...
public static class SliderWidgetDefaults
{
    public const string ProviderSystemName = "Widgets.Slider";
    public const string FriendlyName = "Widgets.Slider.FriendlyName";
    public const string ConfigurationUrl = "../WidgetsSlider/Configure";
