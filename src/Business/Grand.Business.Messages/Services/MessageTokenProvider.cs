...
namespace Grand.Business.Messages.Services
{
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        public async Task AddMerchandiseReturnTokens(LiquidObject liquidObject, MerchandiseReturn merchandiseReturn, Store store, Order order, Language language, MerchandiseReturnNote merchandiseReturnNote = null)
        {
        ...
        public async Task AddGiftVoucherTokens(LiquidObject liquidObject, GiftVoucher giftVoucher, Language language)
        {
        ...
        public async Task AddOutOfStockTokens(LiquidObject liquidObject, Product product, OutOfStockSubscription subscription, Store store, Language language)
        {
