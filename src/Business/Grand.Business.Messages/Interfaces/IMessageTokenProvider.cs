...
namespace Grand.Business.Messages.Interfaces
{
    public partial interface IMessageTokenProvider
    {
        ...
        Task AddMerchandiseReturnTokens(LiquidObject liquidObject, MerchandiseReturn merchandiseReturn, Store store, Order orderItem, Language language, MerchandiseReturnNote merchandiseReturnNote = null);
        Task AddGiftVoucherTokens(LiquidObject liquidObject, GiftVoucher giftVoucher, Language language);
        ...
        Task AddOutOfStockTokens(LiquidObject liquidObject, Product product, OutOfStockSubscription subscription, Store store, Language language);
