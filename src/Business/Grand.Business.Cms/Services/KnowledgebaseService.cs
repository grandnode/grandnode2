...
public class KnowledgebaseService : IKnowledgebaseService
{
    ...
    public virtual async Task<KnowledgebaseCategory> GetPublicKnowledgebaseCategory(string id)
    {
        var key = string.Format(CacheKey.KNOWLEDGEBASE_CATEGORY_BY_ID, id,
            _contextAccessor.WorkContext.CurrentCustomer.GetCustomerGroupIds(),
    ...
    {
        var key = string.Format(CacheKey.ARTICLES, string.Join(",", _contextAccessor.WorkContext.CurrentCustomer.GetCustomerGroupIds()),
            _contextAccessor.StoreContext.CurrentStore.Id);
