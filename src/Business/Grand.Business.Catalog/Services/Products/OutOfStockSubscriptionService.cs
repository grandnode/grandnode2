...
public class OutOfStockSubscriptionService : IOutOfStockSubscriptionService
{
    ...
    /// <returns>Subscriptions</returns>
    public virtual async Task<OutOfStockSubscription> FindSubscription(string customerId, string productId,
    ...
    /// <param name="warehouse">Warehouse ident</param>
    /// <returns>Number of sent email</returns>
    public virtual async Task SendNotificationsToSubscribers(Product product, IList<CustomAttribute> attributes,
        string warehouse)
    {
        ArgumentNullException.ThrowIfNull(product);
