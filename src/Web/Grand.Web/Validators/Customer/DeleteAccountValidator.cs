            ...
            : base(validators)
        {
            ...
            RuleFor(x => x).Custom((x, context) =>
            {
                var pwd = workContext.CurrentCustomer.PasswordFormatId switch {
                    ...
                    PasswordFormat.Encrypted => encryptionService.EncryptText(x.Password, workContext.CurrentCustomer.PasswordSalt),
                    PasswordFormat.Hashed => encryptionService.CreatePasswordHash(x.Password, workContext.CurrentCustomer.PasswordSalt,
