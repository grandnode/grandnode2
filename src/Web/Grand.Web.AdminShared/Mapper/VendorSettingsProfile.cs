...
public class VendorSettingsProfile : Profile, IAutoMapperProfile
{
    public VendorSettingsProfile()
    {
        CreateMap<VendorSettings, VendorSettingsModel>()
            ...
            .ForPath(dest => dest.AddressSettings.StreetAddress2Required,
                mo => mo.MapFrom(p => p.StreetAddress2Required))
        ...
        CreateMap<VendorSettingsModel, VendorSettings>()
            ...
            .ForPath(dest => dest.StreetAddress2Required,
                mo => mo.MapFrom(p => p.AddressSettings.StreetAddress2Required))
            ...
            .ForPath(dest => dest.ZipPostalCodeRequired,
                mo => mo.MapFrom(p => p.AddressSettings.ZipPostalCodeRequired));
    }
