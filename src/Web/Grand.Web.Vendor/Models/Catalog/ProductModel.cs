...
namespace Grand.Web.Vendor.Models.Catalog
{
    public class ProductModel : BaseEntityModel, ILocalizedModel<ProductLocalizedModel>
    {
        ...
        public class ProductAttributeMappingModel : BaseEntityModel, IProductValidVendor
        {
            ...
            [GrandResourceDisplayName("Vendor.Catalog.Products.ProductAttributes.Attributes.ValidationRules.FileAllowedExtensions")]

            public string ValidationFileAllowedExtensions { get; set; }

            [GrandResourceDisplayName("Vendor.Catalog.Products.ProductAttributes.Attributes.ValidationRules.FileMaximumSize")]
            [UIHint("Int32Nullable")]
        ...
        public class ProductAttributeValueModel : BaseEntityModel, ILocalizedModel<ProductAttributeValueLocalizedModel>, IProductValidVendor
        {
            ...
            [GrandResourceDisplayName("Vendor.Catalog.Products.ProductAttributes.Attributes.Values.Fields.AttributeValueType")]
            public AttributeValueType AttributeValueTypeId { get; set; }
            [GrandResourceDisplayName("Vendor.Catalog.Products.ProductAttributes.Attributes.Values.Fields.AttributeValueType")]
            public string AttributeValueTypeName { get; set; }

            [GrandResourceDisplayName("Vendor.Catalog.Products.ProductAttributes.Attributes.Values.Fields.AssociatedProduct")]
            ...
            [GrandResourceDisplayName("Vendor.Catalog.Products.ProductAttributes.Attributes.Values.Fields.ImageSquaresPicture")]
            [UIHint("Picture")]
            ...
            public string PrimaryStoreCurrencyCode { get; set; }
            [GrandResourceDisplayName("Vendor.Catalog.Products.ProductAttributes.Attributes.Values.Fields.WeightAdjustment")]
        ...
        public class ProductAttributeCombinationModel : BaseEntityModel, IProductValidVendor
        {
            ...
            [GrandResourceDisplayName("Vendor.Catalog.Products.ProductAttributes.AttributeCombinations.Fields.AllowOutOfStockOrders")]
            ...
            [GrandResourceDisplayName("Vendor.Catalog.Products.ProductAttributes.AttributeCombinations.Fields.NotifyAdminForQuantityBelow")]
            public int NotifyAdminForQuantityBelow { get; set; }
