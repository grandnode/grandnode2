    ...
    public class HomeController : BaseVendorController
    {
            ...
            string countryId, bool? addSelectStateItem, bool? addAsterisk)
        {
            ...
            if (string.IsNullOrEmpty(countryId))
                return Json(new List<dynamic> { new { id = "", name = translationService.GetResource("Address.SelectState") } });
            ...
            else
            {
                if (country == null)
                {
                    ...
                    {
                        result.Insert(0, new { id = "", name = translationService.GetResource("Vendor.Address.SelectState") });
                    }
                }
                else
                {
