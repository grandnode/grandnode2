...
public class AddCrossSellProductModelValidator : BaseStoreAccessValidator<ProductModel.AddCrossSellProductModel, Product>
{
    ...
    protected override async Task<Product> GetEntity(ProductModel.AddCrossSellProductModel model)
    {
