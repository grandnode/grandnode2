...
public class ProductCategoryModelValidator : BaseStoreAccessValidator<ProductModel.ProductCategoryModel, Product>
{
    ...
    protected override async Task<Product> GetEntity(ProductModel.ProductCategoryModel model)
    {
