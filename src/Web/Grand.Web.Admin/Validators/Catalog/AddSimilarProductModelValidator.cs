...
public class AddSimilarProductModelValidator : BaseStoreAccessValidator<ProductModel.AddSimilarProductModel, Product>
{
    ...
    protected override async Task<Product> GetEntity(ProductModel.AddSimilarProductModel model)
    {
